            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">MENU PERATURAN INTERNAL</h3>
                  <h6 class="font-weight-normal mb-0">Update Tampilan <a href="http://upm.ilkom.unsri.ac.id/peraturan">INTERNAL</a></h6>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-12">
						<form action="/admin-update-internal" method="POST" enctype="multipart/form-data">
                          @csrf
                          
                          <div class="form-group">
                            <label for="exampleInputEmail1">Judul <b>Peraturan Internal</b></label>
                            <input class="form-control" type="text" name="tim_judul" value="{{ $tim->profil_tim_judul }}">
                          </div>
                          
                          <div class="form-group">
                            <label for="exampleInputEmail1">Upload <b>File Peraturan Internal</b></label>
                          ...
                          <div class="form-group">
                            <label for="exampleInputEmail1">Deskripsi <b>Peraturan Internal</b></label>
