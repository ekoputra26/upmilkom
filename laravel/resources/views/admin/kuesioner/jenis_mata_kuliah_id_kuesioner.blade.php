...
@section('content')
    ...
    <div class="main-panel">
        ...
        <div class="content-wrapper">
            ...
            <form method="POST" action="/admin-edit-data-jenis-mata-kuliah">
                @csrf

                <input type="hidden" name="jenisMKId" value="{{ $jenisMK->id }}">

                <div class="form-group mt-3">
                    <label for="jenis">Jenis Mata Kuliah</label>
                    <input type="text" class="form-control" id="jenis" value="{{ $jenisMK->jenis }}" name="jenis">
                </div>
