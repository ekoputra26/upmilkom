...
@section('content')
    ...
    <div class="main-panel">
        ...
        <div class="content-wrapper">
                ...
                <div class="col-md-12 grid-margin">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            ...
                            <h3 class="font-weight-bold">IMPORT DATA DOSEN</h3>
            ...
            <form method="POST" action="/admin-import-data-dosen" enctype="multipart/form-data">
            @csrf
              <div class="form-group">
                <label for="file_container">Import Data Dosen (dalam bentuk Excel .xlsx)</label>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <ul>
                        ...
                        <li>Susun isi file sehingga sesuai dengan gambar di samping, atau <a href="/storage/template_dosen.xlsx">download template ini.</a></li>
                        <li>Data yang di-import akan <strong>ditambahkan</strong> ke dalam database, bukan menggantikan data yang telah ada.</li>
                    </ul>
                </div>
                <img src="img/dosen.png" class="col" />
            </div>
