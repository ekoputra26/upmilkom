...
@section('content')
    ...
    <div class="main-panel">
        ...
        <div class="content-wrapper">
            ...
            <form method="POST" action="/admin-edit-data-ruangan">
                @csrf

                <input type="hidden" name="ruanganId" value="{{ $ruangan->id }}">

                <div class="form-group mt-3">
                    <label for="nama">Nama Ruangan</label>
                    <input type="text" class="form-control" id="nama" value="{{ $ruangan->nama }}" name="nama">
                </div>

                <div class="form-group mt-3">
                    <label for="lokasi">Lokasi</label>
                    <select class="form-control border-dark" id="lokasi" name="lokasi">
                        <option value="Indralaya" @if ($ruangan->lokasi === 'Indralaya') selected @endif>Indralaya</option>
                        <option value="Palembang" @if ($ruangan->lokasi === 'Palembang') selected @endif>Palembang</option>
                    </select>
                </div>
