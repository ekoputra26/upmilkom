...
@section('content')
    ...
    <div class="main-panel">
        ...
        <div class="content-wrapper">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            ...
                            <h3 class="font-weight-bold mt-4">BUAT DATA MATA KULIAH KUESIONER</h3>
            ...
            <form method="POST" action="/admin-new-data-mata-kuliah">
                @csrf
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="number" class="form-control" id="kurikulum" name="kurikulum">
                </div>
