...
@section('content')
    ...
    <div class="main-panel">
        ...
        <div class="content-wrapper">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            ...
                            <h3 class="font-weight-bold mt-4">EDIT DATA DESKRIPSI KUESIONER</h3>
            ...
            <form method="POST" action="/admin-edit-data-deskripsi">
                @csrf
                <textarea name="deskripsi" id="deskripsi" cols="30" rows="10" class="ckeditor">{!! $deskripsi !!}</textarea>
