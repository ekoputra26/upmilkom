...
@section('content')
    ...
    <div class="main-panel">
        ...
        <div class="content-wrapper">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            ...
                            <h3 class="font-weight-bold mt-4">EDIT DATA PRODI {{ Str::upper($prodi->nama) }}</h3>
            ...
            <form method="POST" action="/admin-edit-data-prodi">
                @csrf
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" class="form-control" id="nama" value="{{ $prodi->nama }}" name="nama">
                </div>

                <div class="form-group mt-3">
                    <label for="jenjang">Jenjang</label>
                    <input type="text" class="form-control" id="jenjang" value="{{ $prodi->jenjang }}" name="jenjang">
                </div>
