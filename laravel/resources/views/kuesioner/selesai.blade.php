...
<body>
    ...
    <div class="container mt-4 text-center fw-bold">
        Terima kasih telah mengisi kuesioner ini. Jawaban Anda telah direkam.
    </div>
    <div class="text-center mt-3">
        <a href="/">Kembali ke halaman UPM</a>
        <a href="/kuesioner" class="ms-5">Isi kuesioner lagi</a>
    </div>
